...
2026-09-19
* 下载权重`vllm-ascend/MiniMax-M2.7-w8a8-QuaRot`，路径`/mnt/d/s/modelscope/vllm-ascend/MiniMax-M2.7-w8a8-QuaRot/`
* 下载权重`MiniMaxAI/MiniMax-M2.7`，路径`/mnt/d/s/hf/MiniMaxAI/MiniMax-M2.7/`

2026-09-18
* 删除权重`deepseek-ai/DeepSeek-V4`，路径`/mnt/d/s/hf/deepseek-ai/DeepSeek-V4/`
* 删除权重`deepseek-ai/DeepSeek-V4-Flash`， 路径`/mnt/d/s/hf/deepseek-ai/DeepSeek-V4-Flash/`
* 删除权重`Eco-Tech/DeepSeek-V4-Flash-w8a8-mtp`， 路径`/mnt/d/s/modelscope/Eco-Tech/DeepSeek-V4-Flash-w8a8-mtp/`
* 删除权重`Eco-Tech/DeepSeek-V4-Pro-w4a8-mtp`， 路径`/mnt/d/s/modelscope/Eco-Tech/DeepSeek-V4-Pro-w4a8-mtp/`
...
* 删除 docker 镜像`/mnt/d/s/docker_images/vllm-ascend-v0.22.1rc1.tar`
* 删除 docker 镜像`/mnt/d/s/docker_images/vllm-ascend-v0.23.0rc1.tar`
* 删除 docker 镜像`/mnt/d/s/docker_images/vllm-omni-v0.18.0.tar`
